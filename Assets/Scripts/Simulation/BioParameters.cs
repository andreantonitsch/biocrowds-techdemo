...
namespace BioCrowdsTechDemo
{
    ...
    public struct BioParameters
    {
        ...
        /// </summary>
        /*[SerializeField][Range(0, 512)]*/ public int markers;

        /// <summary>
        /// Maximum agent speed in m/s.
        /// </summary>
        /*[SerializeField][Range(0f, 10f)]*/ public float max_agent_speed;
        ...
        /// </summary>
        /*[SerializeField][Range(0f, 3f)] */public float agent_radius;

        /// <summary>
        /// Agent Line of Sight.
        /// An Agent only captures a sampled space marker if the marker is within this LOS distance.
        /// </summary>
        /*[SerializeField] [Range(1f, 10f)]*/ public float agent_LOS;
        ...
        /// </summary>
        /*[SerializeField] [Range(0f, 0.5f)] */public float movement_epsilon;
